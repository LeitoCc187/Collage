...
public class Programmingproject1 
{
    public static void main(String[] args) throws IOException
        ...
        // Flag to quit the game and return to the main menu
        boolean quit = false;
        boolean back = false;
        ...
        */
        ...
        while (!quit)
        {
            ...
            System.out.println("1 - Rock, Paper, Scissors - High Score: " + hscorerps);
            System.out.println("2 - Hang Man - High Score: " + hscorehm);
            ...
            if (choice == 1) // Starting the Rock, Paper, Scissors Game
            {
                back = false;
                ...
                while (!back)
                {
                    ...
                    else if ((choice + 1) % 3 == botchoice) // User lost scenario
                    {
                        ...
                        if (choice == 2)  // User returns to main menu scenario
                        {
                            back = true;
                        }
                        else // Invalid Choice
            ...
            else if (choice == 2) // Hangman Game
            {
                ...
                while (!back) 
                {
                    ...
                    {
                        back = true; // Exit the Hangman game loop
                    }
                }
            }
            else if (choice == 3) // Quit The Game
            {
                quit = true;
            }
            else // Invalid Choice
