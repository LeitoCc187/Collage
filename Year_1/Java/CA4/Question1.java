/*
 * Calculate the average running time and average speed for each athlete 
 * and store the obtained valuesin another two parallel arrays.
 * Display all arrays in a neat table
 */
